 ...
 * @author JeiMchfundi
 */
public class JUtil<T> {
	private StandardServiceRegistry registry;
	private SessionFactory sessionFactory;
	private final Class<T> classObj;

	public JUtil(Class<T> classObj) {
	...
	public SessionFactory getSessionFactory() {
		if (sessionFactory == null)
			try {
				...
				settings.put("hibernate.default_schema", "JU");
				settings.put("hibernate.dialect", "org.hibernate.dialect.DerbyDialect");
